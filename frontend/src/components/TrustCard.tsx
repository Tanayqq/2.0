      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-slate-300">
        <div className="space-y-1.5">
          <span className="text-[10px] font-mono-dash text-slate-500 uppercase tracking-widest flex items-center gap-1">
            <CheckCircle2 className="h-3 w-3 text-cyan-500" /> Consensus Rationale
          </span>
          <p className="text-xs text-slate-200 leading-relaxed font-sans">
            {summary.rationale || "Multiple independent clinical guidelines and FDA labels agree on this recommendation."}
          </p>
        </div>

        <div className="space-y-1.5">
          <span className="text-[10px] font-mono-dash text-slate-500 uppercase tracking-widest flex items-center gap-1">
            <Award className="h-3 w-3 text-indigo-400" /> Sources Used ({summary.sources_used?.length || 0})
          </span>
